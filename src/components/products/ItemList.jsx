...
const Item = ({ props }) => {
    ...
    return (<>
        ...
        {showDialog ? <div>
            <div onClick={dialogClose} className='fixed inset-0 top-0 bottom-0 left-0 right-0 z-40 w-screen h-screen bg-white/50'></div>
            <div className='fixed inset-0 top-0 bottom-0 left-0 right-0 z-50 w-screen h-screen pointer-events-none'>
                <section className="absolute z-50 w-1/2 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl pointer-events-auto left-1/4 top-1/4 md:grid md:grid-cols-3">
                    ...
                    <div className="p-4 text-center sm:p-6 md:col-span-2 lg:p-8">
                        ...
                        <p className="text-2xl font-semibold tracking-widest text-purple-400 uppercase">
                            <b className="text-3xl">({qty})</b> {title}
                        </p>

                        <h2 className="mt-6 font-black uppercase">
                            <span className="text-3xl font-black sm:text-3xl lg:text-3xl">
                                obten 20% off
                                <div className="text-xl">si participan 2 pesonas! </div>
                            </span>
                        </h2>
                        <p className="mt-8 text-xs font-medium text-gray-400 uppercase">
                            Consulta por otras promociones
                        </p>
