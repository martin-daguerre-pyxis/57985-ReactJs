const CartWidget = () =>  {
    return (<>
        <button className="relative inline-flex items-center px-3 pt-4 pb-3 mt-3 text-base border-0 bg-purple-300/20 rounded-t-xl top-2 focus:outline-none hover:bg-white md:-my-1">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-8 fill-purple-400" viewBox="0 0 1024 1024">
