...
const CartWidget = () =>  {
    return (<>
        <button className="relative inline-flex items-center px-3 pt-4 pb-3 mt-3 text-base border-0 bg-purple-300/40 rounded-t-xl top-2 focus:outline-none hover:bg-[aliceblue] md:-my-1">
        <Link to={`/cart`}>
